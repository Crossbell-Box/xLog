...
function OIAPage() {
  ...
  const download = useCallback(() => {
    if(isAndroid()){
      window.open("https://play.google.com/store/apps/details?id=com.crossbell.xlog");
    } else {
      window.open("itms-apps://apps.apple.com/app/xlog-on-chain-blogging/id6449499296");
    }
  }, [])
